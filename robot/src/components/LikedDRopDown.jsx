...
function LikedDrop({ show_shop_modal }) {
    ...
    const updateQuantity = async (id, change) => {
        ...
        await axiosInstance
            ...
            .then(() => {
                ...
                queryClient.refetchQueries({ queryKey: ['basket_items'] });
            })
            .catch((error) => {
                              ...
                              <div className="flex flex-col w-full max-md:max-w-full">
                                  <div className="flex gap-8 items-center mt-6 text-sm font-medium max-md:max-w-full">
                                      <div className="flex gap-1 items-center self-stretch my-auto min-w-[240px] text-green-950">
                                          {/* Skeleton Image */}
                                          <div className="bg-gray-300 animate-pulse rounded-3xl w-[134px] h-[134px]"></div>

                                          {/* Skeleton Text */}
                                          <div className="bg-gray-300 animate-pulse h-6 w-[152px] rounded-md"></div>
                                      </div>
                                  </div>
