...
export default function VakumusHeroRight({ Vakumus_Hero, Translates }) {
    ...
    return (
        ...
        >
            <motion.div
                ...
                className="flex flex-col max-w-full min-h-[226px] w-[40%]"
            >
                <motion.h1
            ...
            <motion.div
                className="flex flex-col items-center mt-16 w-[50px] max-md:mt-10 cursor-pointer"
                animate={{ y: [0, -10, 0] }}
                transition={{
                    repeat: Infinity,
                    duration: 1.5,
