...
function ProductCardNew() {
    return (
        <article className="flex overflow-hidden flex-col grow shrink self-stretch pt-7 pl-7 my-auto rounded-3xl bg-[#132A1B] min-w-[240px] lg:w-1/2  md:lg:w-full max-md:max-w-full">
            ...
            <img
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/38fe4a76bfcf61cb490e9d8f0806cbaad82e5085d4a77a86790b7df295644920?placeholderIfAbsent=true&apiKey=c6f3c7bb740649e5a32c147b3037a1c2"
